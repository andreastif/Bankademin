...
class ControllerTest {
    ...
    void successfullTransferToOtherAccountTest() {
        ...
        Customer martin = new Customer("123","Martin Rov", "1", LocalDate.parse("1995-01-01"), new Account("martins konto", 5000));
    ...
    void failTransferToOtherAccountTest() {
        ...
        Customer martin = new Customer("123","Martin Rov", "1", LocalDate.parse("1995-01-01"), new Account("martins konto", 0));
    ...
    void testFindMyTransactions() {
        ...
        Customer martin = new Customer("123456","Martin Rov", "123pass", LocalDate.parse("1987-02-05"), new Account("313303104605", 397600.0));
